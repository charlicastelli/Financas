...
final String descricaoCatColumn = "descricaoCatColumn";
final String descricaoCatRcColumn = "descricaoCatRcColumn";
  ...
  Future<Database> initDb() async {
    ...
    return await openDatabase(path, version: 1,
      ...
      await db.execute("CREATE TABLE $movimentacaoTABLE(" +
          ...
          "$dataColumn TEXT," +
          "$tipoColumn TEXT," +
          "$descricaoCatColumn TEXT," +
          "$descricaoCatRcColumn TEXT,"
...
class Movimentacoes {
  ...
  Movimentacoes.fromMap(Map map) {
    ...
    data = map[dataColumn];
    tipo = map[tipoColumn];
    descricaoCat = map[descricaoCatColumn];
    descricaoCatRc = map[descricaoCatRcColumn];
  ...
  Map toMap() {
    Map<String, dynamic> map = {
      ...
      dataColumn: data,
      tipoColumn: tipo,
      descricaoCatColumn: descricaoCat,
      descricaoCatRcColumn: descricaoCatRc,
  ...
  String toString() {
    return "Movimentaoes(id: $id, valor: $valor, data: $data, tipo: $tipo, cat: $descricaoCat, catRc: $descricaoCatRc, desc: $descricao, )";
  }
}
